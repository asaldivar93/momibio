...
#Load Data
data = np.loadtxt("CIR_B1_270320_0.txt", delimiter ='\t', skiprows = 11)
data2 = np.loadtxt('CIR_B2_270320_0.txt', delimiter ='\t', skiprows = 11)
...
window_size, poly_order = len(Time[Time<25]), 3
...
np.savetxt('resultados_0327.txt', save, delimiter = '\t')
