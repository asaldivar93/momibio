...
#Load Data
data = np.loadtxt("CIR_B1_200320_0.txt", delimiter ='\t', skiprows = 11)
data2 = np.loadtxt('CIR_B1_200320_1.txt', delimiter ='\t', skiprows = 0)
data3 = np.loadtxt('CIR_B1_200320_2.txt', delimiter ='\t', skiprows = 0)
...
save = np.stack((Time, OD, sg_OD, mu), axis = -1)
np.savetxt('resultados_0320.txt', save, delimiter = '\t')
